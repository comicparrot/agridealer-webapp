<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="orderHistoryMaster.aspx.cs" Inherits="DemeterMachine.orderHistoryMaster" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">

<section class="orderHistorySection">
    <div class="body-content">
     <h1>Order History Master Page</h1>
     <h6 class="">Please select an order to view the order details</h6>
        ...
        <div class="gridViewOverFlow mt-2">
         <asp:GridView ID="GridView2" runat="server" HorizontalAlign="Center" 
            ...
            <FooterStyle BackColor="#8B181B" Font-Bold="True" ForeColor="White" />
            <HeaderStyle BackColor="#8B181B" Font-Bold="True" ForeColor="White" />
            <PagerStyle BackColor="#8B181B" ForeColor="White" HorizontalAlign="Center" />
            <RowStyle BackColor="#F7F6F3" ForeColor="#333333" />
            <SelectedRowStyle BackColor="#E2DED6" Font-Bold="True" ForeColor="#333333" />
            <SortedAscendingCellStyle BackColor="#E9E7E2" />
            <SortedAscendingHeaderStyle BackColor="#506C8C" />
