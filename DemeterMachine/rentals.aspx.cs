...
namespace DemeterMachine
{
    public partial class rentals : System.Web.UI.Page
    {
        ...
        private void ApplyFilter()
        {
            ...
            dsRentals.SelectCommand = @"SELECT serial_number, model, model_year, equipment_condition, type, price,brand 
                                 FROM productSearch 
                                 WHERE (1 = 1 and equipment_condition = 'Used' " /*+ whereClause*/ + joinedType + joinedBrand + ");";
        ...
        protected string GetProductDetailUrl(object serialNumber, object type)
        {
            ...
            if (type.ToString().Equals("tractor", StringComparison.OrdinalIgnoreCase) || type.ToString().Equals("combine",
                StringComparison.OrdinalIgnoreCase) || type.ToString().Equals("sprayer", StringComparison.OrdinalIgnoreCase))
            {
        ...
        protected void JohnDeere_CheckedChanged(object sender, EventArgs e)
        {
